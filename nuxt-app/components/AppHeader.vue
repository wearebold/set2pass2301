  ...
  <header class="site-header | py-5 fixed top-0 x-0 w-full">
    <div class="l-container l-container--1440 | flex justify-between items-center">
      ...
      <nav ref="siteNav"  class="c-nav c-nav--primary | inline-flex ml-auto font-display" data-target-site-nav id="a11y-nav-primary">
        <nuxt-link to="/about" @click="clearState" class="text-xs mx-4">About Us</nuxt-link>
        <nuxt-link to="/stories" @click="clearState" class="text-xs mx-4">Stories</nuxt-link>
        <nuxt-link to="/pricing" @click="clearState" class="text-xs mx-4">Pricing</nuxt-link>
        <nuxt-link to="/faqs" @click="clearState" class="text-xs mx-4">FAQ's</nuxt-link>
        <nuxt-link to="/contact" @click="clearState" class="text-xs mx-4 | md:hidden">Contact</nuxt-link>
